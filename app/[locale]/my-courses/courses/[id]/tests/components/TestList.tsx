    ...
    <div className="container mx-auto px-4">
      ...
      {renderedTests.length === 0 ? (
        ...
        renderedTests.map((test) => (
          <div
            key={test.id}
            className="bg-white p-4 md:py-9  md:px-16 border border-brand-border mb-6 rounded-xl pb-12"
          >
            {/* Title and Status */}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      {test.start_date && test.due_date ? (
                        ...
                        <div className="text-sm text-gray-500">No dates set</div>
                      )}
                    </div>
                  </div>
                <div className="flex items-center gap-2">
