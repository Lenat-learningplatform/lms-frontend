...
// const SecondHeaderContent = ({ children }: { children: React.ReactNode }) => {
...
//         <div
//           className={cn(
//             "flex-none   bg-default backdrop-blur-lg md:px-6 px-[15px] py-3    xl:ms-[300px] flex items-center justify-between  relative",
//             headerTheme,
//             {
...
//       <div
//         className={cn(
//           "flex-none    bg-default backdrop-blur-lg md:px-6 px-[15px] py-3    xl:ms-[248px]  flex items-center justify-between relative",
//           headerTheme,
//           {
...
// export default SecondHeaderContent;
"use client";
import React from "react";
import { useConfig } from "@/hooks/use-config";
import { cn } from "@/lib/utils";
...
const SecondHeaderContent = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <header
      className={cn("top-[50px] z-50", config.navbar, {
        "has-sticky-header sticky top-6 px-6": config.navbar === "floating",
      })}
    >
      <div
        className={cn(
          "flex-none bg-brand-body backdrop-blur-lg md:px-6 px-[15px] py-6 flex items-center justify-between relative",
          headerTheme
        )}
      >
