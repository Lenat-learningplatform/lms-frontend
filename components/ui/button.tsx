...
const buttonVariants = cva(
  "inline-flex items-center justify-center px-4 md:px-6 whitespace-nowrap rounded-none text-sm font-medium transition-all duration-300 hover:ring-2 hover:ring-offset-2 ring-offset-background transition-all focus-visible:outline-none focus-visible:hidden focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      color: {
        default:
          "bg-brand-light text-default-foreground hover:bg-brand-light/90 hover:ring-default dark:disabled:bg-brand-light-500 ",
        primary:
      ...
      variant: {
        default: "",
        outline:
          "border  border-brand-light text-default bg-transparent hover:bg-brand-light hover:text-default-foreground hover:ring-0 hover:ring-transparent",
        soft: "text-default bg-brand-light/10 hover:bg-brand-light  hover:text-default-foreground",
        ghost:
          "text-default bg-transparent hover:bg-brand-light  hover:text-default-foreground hover:ring-0 hover:ring-transparent hover:ring-offset-0",
        shadow: "shadow-md",
      },
      shadow: {
        sm: "shadow",
